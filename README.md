...
|-----------|-----------------|-----------------|--------------------------------|---------|----|
| `php/`    | Composer        | [`spart/sdk`](https://packagist.org/packages/spart/sdk) | Full SDK                       | [![Packagist version](https://img.shields.io/packagist/v/spart/sdk.svg?logo=packagist&logoColor=white)](https://packagist.org/packages/spart/sdk) | [![php CI](https://github.com/SpartPay/spart-sdks/actions/workflows/php.yml/badge.svg)](https://github.com/SpartPay/spart-sdks/actions/workflows/php.yml) |
